...
class ShortCircuit(WebsiteEventSaleController):
    # the following function is to overwrite the registration_confirm fuction in WebsiteEventSalesController
    @http.route()
    def registration_confirm(self, event, **post):
        ...
        # works but type problem and if only above class is (WebsiteEventController) 
        #res = super(WebsiteEventSaleController, self).registration_confirm(event, **post)
        # regular path
        #res = super(ShortCircuit, self).registration_confirm(event, **post)
        res = WebsiteEventController.registration_confirm(self, event, **post)
        # use the following:
